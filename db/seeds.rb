...
#     date_time: Faker::Date.between(from: '2022-10-01', to: '2022-10-31'),
#     submission_deadline: Faker::Date.between(from: '2022-10-11', to: '2022-10-31'),
...
s1 = Song.create(
    ...
    start_time: '0:10',
    end_time: '0:15',
    power_hour_id: PowerHour.first.id,
